...
public class Interface_biblAnima extends JFrame {
	...
	public Interface_biblAnima() {
		...
		login.add(mostrar_password);
				...
				passIcon.setIcon(new ImageIcon("/padlock.png"));
			...
			//Alta usuario
				btnAceptar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						int cedula = Integer.parseInt(inputCI.getText().toString());
						String nombre = inputNombre.getText().toString();
						String apellido = inputApellido.getText().toString();
						String mail = inputMail.getText().toString();
						String pass = inputPassword.getPassword().toString();
						...
						try {							
							man.altaUsuario(cedula, nombre, apellido, mail, pass, tipo, orient);
						}catch (Exception a) {
							System.out.println(a);
							JOptionPane.showMessageDialog(null, "Error al intentar crear usuario, revise los datos.");
						}
				...
				btnCancelar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						}else if(menuBar.isVisible() == true) {
